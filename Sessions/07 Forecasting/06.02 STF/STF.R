...
rownames(fbar_scenarios) <- c(fbar_multiplier)
fbar_scenarios

# Add the F0.1 scenario as a final scenario
fbar_scenarios <- rbind(fbar_scenarios, f01=c(fbar_status_quo,f01,f01))
...
stk_stf <- FLStocks(vector('list'), length=nrow(fbar_scenarios))
